...
class Application:
    ...
    def __init__(self):
        ...
        self.panel4.place(x = 220, y = 455)

        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 455)
        ...
        self.bt1.place(x = 26, y = 605)

        self.bt2 = tk.Button(self.root, command = self.action2, height = 0, width = 0)
        self.bt2.place(x = 325, y = 605)

        self.bt3 = tk.Button(self.root, command = self.action3, height = 0, width = 0)
        self.bt3.place(x = 625, y = 605)
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            predicts_generator = self.hs.suggest(self.word)

            predicts = list(predicts_generator)
